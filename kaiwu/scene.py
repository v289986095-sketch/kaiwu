...
_SCENE_KEYWORDS: list[tuple[str, list[str]]] = [
    ...
    ("react", ["react", "jsx", "tsx", "组件", "component", "shadcn", "nextjs", "next.js", "antd", "ant design"]),
    ("dataviz", ["图表", "chart", "echarts", "可视化", "dashboard", "仪表盘", "plotly", "d3", "大屏"]),
    ("game_dev", ["游戏", "game", "canvas", "sprite", "碰撞", "collision", "2d游戏", "小游戏"]),
    ("test_case", ["测试", "test", "pytest", "unittest", "单元测试", "用例", "assert", "mock", "jest", "vitest"]),
    ("code_review", ["审查", "review", "code review", "代码审查", "CR", "走查"]),
    ("web", ["网页", "html", "页面", "landing", "前端", "tailwind", "css", "website", "网站",
             "vue", "vue3", "nuxt", "element plus", "element-plus", "elementui",
             "angular", "svelte", "vite", "webpack", "bootstrap"]),
    ("backend_api", ["api", "fastapi", "flask", "django", "后端", "接口", "endpoint", "路由",
                     "express", "koa", "nest", "spring", "gin"]),
    ("database", ["数据库", "database", "sql", "mysql", "postgres", "sqlite", "建表", "migration",
                  "mongodb", "redis", "orm", "prisma", "sequelize", "sqlalchemy"]),
    ("data_analysis", ["pandas", "数据分析", "dataframe", "excel分析", "numpy", "jupyter", "matplotlib"]),
    ("web_scraping", ["爬虫", "scraping", "crawl", "抓取", "spider", "selenium", "playwright爬",
                      "beautifulsoup", "scrapy", "puppeteer"]),
    ("copywriting", ["文案", "营销", "广告", "推文", "软文", "slogan", "标题党"]),
    ("shell_script", ["shell", "bash", "脚本.sh", ".sh", "运维脚本", "部署脚本", "cron", "systemctl"]),
    ("python_script", ["python脚本", "py脚本", "命令行工具", "cli工具", "argparse", "click"]),
    ("china_deploy", ["部署", "deploy", "nginx", "systemd", "gunicorn", "宝塔", "服务器", "云服务器", "备案",
                      "docker", "docker-compose", "k8s", "kubernetes", "pm2", "supervisor"]),
    ("wechat_pay", ["微信支付", "wechat pay", "支付宝", "alipay", "小程序支付", "jsapi", "回调通知",
                    "小程序", "miniprogram", "公众号", "企业微信"]),
]
