...
_TAG_PRIORITY = {
    "backend_api":  {MEMORY_TAG_IMPL: 1.0, MEMORY_TAG_ERR: 0.8, MEMORY_TAG_PREF: 0.6, MEMORY_TAG_CTX: 0.5, MEMORY_TAG_PROC: 0.3},
    "web":          {MEMORY_TAG_IMPL: 1.0, MEMORY_TAG_ERR: 0.8, MEMORY_TAG_PREF: 0.6, MEMORY_TAG_CTX: 0.5, MEMORY_TAG_PROC: 0.3},
    "react":        {MEMORY_TAG_IMPL: 1.0, MEMORY_TAG_ERR: 0.8, MEMORY_TAG_PREF: 0.7, MEMORY_TAG_CTX: 0.5, MEMORY_TAG_PROC: 0.3},
    "debug":        {MEMORY_TAG_ERR: 1.0, MEMORY_TAG_IMPL: 0.7, MEMORY_TAG_PREF: 0.4, MEMORY_TAG_CTX: 0.5, MEMORY_TAG_PROC: 0.3},
    "code_review":  {MEMORY_TAG_PREF: 1.0, MEMORY_TAG_IMPL: 0.7, MEMORY_TAG_ERR: 0.6, MEMORY_TAG_CTX: 0.5, MEMORY_TAG_PROC: 0.4},
    "refactor":     {MEMORY_TAG_PROC: 1.0, MEMORY_TAG_IMPL: 0.8, MEMORY_TAG_ERR: 0.6, MEMORY_TAG_CTX: 0.7, MEMORY_TAG_PREF: 0.5},
    "shell_script": {MEMORY_TAG_PROC: 1.0, MEMORY_TAG_IMPL: 0.7, MEMORY_TAG_ERR: 0.8, MEMORY_TAG_CTX: 0.5, MEMORY_TAG_PREF: 0.3},
}
_DEFAULT_TAG_PRIORITY = {MEMORY_TAG_IMPL: 0.8, MEMORY_TAG_ERR: 0.7, MEMORY_TAG_PREF: 0.5, MEMORY_TAG_CTX: 0.6, MEMORY_TAG_PROC: 0.4}
